...
```{r}
JJJJ=list(name="KYRIECHEN",sexy="male",age=20,movie="q,w,e",reason="i like the R")
JJJJ
```
...
```{r}
CJJ= list(name="11",age=21,movie="r,t,y",reason="jj")
```
...
```{r}
ls=list(the=c(1,5),here=2,means=3,that=4,first=6,item=7)
```
